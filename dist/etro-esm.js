...
var Movie = /** @class */ (function () {
    ...
    Movie.prototype._newRender = function (repeat, timestamp, duration) {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this.currentTime > end) {
                ...
                _this._lastPlayed = performance.now();
                _this._lastPlayedOffset = 0; // this.currentTime
                _this._renderingFrame = false;
                // Stop playback or recording if done (except if it's playing and repeat
                // is true)
                if (!(!_this.recording && _this.repeat)) {
                    _this._paused = true;
                    _this._ended = true;
                    // Deactivate all layers
                    for (var i = 0; i < _this.layers.length; i++)
                        if (Object.prototype.hasOwnProperty.call(_this.layers, i)) {
            ...
            _this._applyEffects();
            if (frameFullyLoaded)
                publish(_this, 'movie.loadeddata', { movie: _this });
            resolve(true);
            // If didn't load in this instant, repeatedly frame-render until frame is
            // loaded.
            // If the expression below is false, don't publish an event, just silently
            // stop render loop.
            if (!repeat || (_this._renderingFrame && frameFullyLoaded)) {
                _this._renderingFrame = false;
                resolve(true);
                return;
            }
    ...
    Object.defineProperty(Movie.prototype, "actualFramerate", {
        get: function () {
    ...
    Object.defineProperty(Movie.prototype, "mediaReady", {
        get: function () {
